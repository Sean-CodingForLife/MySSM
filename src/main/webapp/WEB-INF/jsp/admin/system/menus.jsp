...
<html>
<head>
    <title><spring:message code="admin.menus.title"/></title>
    ...
    <script type="text/javascript">
        ...
        var state = createListState("${pageContext.request.contextPath}/api/admin/menus", 10, { keyword: "" });
        var columns = [
            ...
            { key: "permission_code", label: "<spring:message code="common.permission"/>" },
            { key: "sort", label: "<spring:message code="common.sort"/>" },
            { key: "status", label: "<spring:message code="common.status"/>" }
        ];

        function refreshMenus() {
            loadTable(state, columns, { selectable: false, emptyText: "<spring:message code="admin.menus.empty"/>" });
        }
...
<body>
<spring:message code="admin.menus.title" var="pageTitle"/>
<% request.setAttribute("activeNav", "menus"); %>
<%@ include file="../../common/app-shell-start.jsp" %>
    <header class="content-header">
        <div>
            <h1><spring:message code="admin.menus.title"/></h1>
            <p><spring:message code="admin.menus.breadcrumb"/></p>
        </div>
    </header>
        ...
        <div class="card-body">
            <div class="row g-3 align-items-end">
                <div class="col-12 col-md">
                    ...
                    <input class="form-control" type="text" id="keyword" placeholder="<spring:message code="admin.menus.searchPlaceholder"/>" />
                </div>
                <div class="col-12 col-md-auto d-flex gap-2">
                    <button class="btn btn-primary" type="button" onclick="searchMenus()"><spring:message code="common.search"/></button>
                    <button class="btn btn-outline-secondary" type="button" onclick="state.params.keyword=''; $('#keyword').val(''); searchMenus()"><spring:message code="common.reset"/></button>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="table-responsive">
            <table id="table" class="table table-hover align-middle mb-0">
                ...
                <tr>
                    ...
                    <th><spring:message code="common.permission"/></th>
                    <th><spring:message code="common.sort"/></th>
